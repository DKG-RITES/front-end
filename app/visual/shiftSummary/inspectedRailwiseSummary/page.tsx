...
const inspectedRailwiseSummary = () => {
  const headers = ['Rail Wise Data'];
  const colSpans = [9]; 
  const rows = [
    ['S. No.', 'Rail ID', 'Accp. (A) ', 'Accp. (A+0.1)', 'Rejection'],
    ['1', 'U240524A013', '117 x 1', '', ''],
    ['2', 'U240524A015', '86.67 x 1', '', ''],
    ['3', 'U240524A102', '26 x 1', '', '13 x 1'],
        ...
        <section className='remove-scrollbar container my-auto'>
            <div className='sub-container max-w-[720px] min-h-screen flex items-center justify-center'>
                <div className="flex flex-col items-center bg-gray-100 shadow-lg p-6 rounded-lg w-full max-w-2xl min-h-[600px]">
                    <h1 className="text-3xl font-bold mb-4">Visual - Inspected Railwise Summary</h1>
                    ...
                    <div className='w-full max-w-lg p-8 border border-gray-300 rounded-lg bg-white shadow-lg'>
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex-1">
                                <div className="flex flex-col gap-6 mt-4 items-center">
                                    <select value='Inspected Railwise Summary' onChange={handleSelectChange} className='border h-11 w-44 text-sm rounded-xl border-black pl-2'>
...
export default inspectedRailwiseSummary